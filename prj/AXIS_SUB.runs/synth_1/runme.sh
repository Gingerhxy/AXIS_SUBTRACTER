...
HD_PWD='D:/Code_repositories/fpga_code/AXIS_SUB/prj/AXIS_SUB.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXIS_SUB_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXIS_SUB_wrapper.tcl
