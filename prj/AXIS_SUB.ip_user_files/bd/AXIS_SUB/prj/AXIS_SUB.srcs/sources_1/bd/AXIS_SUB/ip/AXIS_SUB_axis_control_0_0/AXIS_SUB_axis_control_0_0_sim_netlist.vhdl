...
architecture STRUCTURE of AXIS_SUB_axis_control_0_0_axis_control is
  signal \A_FIFO[31]_i_2_n_0\ : STD_LOGIC;
  signal A_FIFO_wen : STD_LOGIC;
  signal A_LAST_i_1_n_0 : STD_LOGIC;
  signal A_LAST_reg_n_0 : STD_LOGIC;
  signal A_VALID : STD_LOGIC;
  signal A_VALID_i_1_n_0 : STD_LOGIC;
  signal A_VALID_i_2_n_0 : STD_LOGIC;
  signal \B_FIFO[31]_i_1_n_0\ : STD_LOGIC;
  signal B_LAST_i_1_n_0 : STD_LOGIC;
  signal B_LAST_reg_n_0 : STD_LOGIC;
  signal B_VALID : STD_LOGIC;
  signal B_VALID_i_1_n_0 : STD_LOGIC;
  signal B_VALID_i_2_n_0 : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of A_VALID_i_2 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of B_LAST_i_1 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of B_VALID_i_2 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of m_axis_result_tvalid_INST_0 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of s_axis_a_tready_INST_0 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of s_axis_b_tready_INST_0 : label is "soft_lutpair2";
begin
...
\A_FIFO[31]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => rst_n,
      O => \A_FIFO[31]_i_2_n_0\
    );
\A_FIFO_reg[0]\: unisim.vcomponents.FDCE
     port map (
      C => clk,
      CE => A_FIFO_wen,
      CLR => \A_FIFO[31]_i_2_n_0\,
      D => s_axis_a_tdata(0),
      Q => A(0)
    );
...
A_LAST_i_1: unisim.vcomponents.LUT6
    generic map(
...
A_VALID_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B3"
    )
        port map (
...
A_VALID_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BAFA30F0"
    )
        port map (
...
B_LAST_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"88F8F8F8"
    )
        port map (
...
B_LAST_reg: unisim.vcomponents.FDCE
     port map (
      C => clk,
      CE => B_VALID_i_1_n_0,
      CLR => \A_FIFO[31]_i_2_n_0\,
...
B_VALID_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"D5"
    )
        port map (
...
B_VALID_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AEEE"
    )
        port map (
...
m_axis_result_tlast_INST_0: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
